...
do
    ...
    do
        ...
        --patience 10\
        --gpu 0\
        --itr 1 --batch_size 32 >logs/synthesized_"$data_version"/$target_node/$model_name'_'$model_id_name'_'$seq_len'_'$pred_len'_ftr'$features'_no-exo_no-exo_future_dm'$d_model.log
    done
done
...
do
    ...
    do
        ...
        --patience 10\
        --gpu 0\
        --itr 1 --batch_size 32 >logs/synthesized_"$data_version"/$target_node/$model_name'_'$model_id_name'_'$seq_len'_'$pred_len'_ftr'$features'_exo_no-exo_future_dm'$d_model.log
    done
done
